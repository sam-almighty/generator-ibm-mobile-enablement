...
module.exports = class extends Generator {
	...
	initializing() {
		this.composeWith(require.resolve('../fastlane'), this.opts);
	...
	prompting() {
		...
		prompts.push({
			...
			default: 'starter-basic-'+Date.now()
		});
		prompts.push({
			type: 'list',
			name: 'language',
	...
	_processAnswers(answers) {
		...
		this.bluemix.testrepo= answers.testrepo.trim();
		this.bluemix.apprepo= answers.apprepo.trim();
	}
